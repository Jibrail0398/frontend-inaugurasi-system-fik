                ...
                <div className="card-body">
                    ...
                    <form id="formAuthentication" className="mb-4" action="index.html" method="GET">
                        <div className="mb-6 form-control-validation">
                            ...
                            <input type="number" className="form-control" id="nim" placeholder="Enter your NIM" autofocus="" value={nim} onChange={(e) => setNim(e.target.value)} />
                        </div>
                        <div className="mb-6 form-password-toggle form-control-validation">
                            ...
                            <div className="input-group input-group-merge">
                                <input type={showPassword ? "text" : "password"} id="password" className="form-control" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="············" aria-describedby="password" />
