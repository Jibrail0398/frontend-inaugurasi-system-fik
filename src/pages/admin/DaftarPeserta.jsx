...
export default function DaftarPeserta() {
  ...
  const handleVerifikasi = async (penerimaanId) => {
    if (!penerimaanId) {
      Swal.fire({
        ...
        text: "Data penerimaan peserta belum tersedia.",
    ...
    const result = await Swal.fire({
      ...
      text: "Yakin ingin memverifikasi peserta ini?",
    ...
    try {
      ...
      Swal.fire({
        icon: "success",
        title: "Berhasil!",
        text: "Status peserta berhasil diperbarui",
        confirmButtonColor: "#667eea",
      });
      setSelectedRow(null);
      fetchPeserta();
      ...
      Swal.fire({
        ...
        text: "Terjadi kesalahan saat verifikasi peserta",
        confirmButtonColor: "#667eea",
      });
    }
  };
  ...
  return (
    <div className="container-fluid">
      ...
      <p className="mb-4">
        Berikut adalah daftar peserta inaugurasi yang sudah terdaftar.
      </p>
        ...
        createPortal(
          <div className="modal-overlay" onClick={() => setSelectedRow(null)}>
            ...
            >
              ...
              <div className="modal-details">
                <p>
                  <b>Kode Peserta:</b> {selectedRow.kode_peserta}
                </p>
                <p>
                ...
                <p>
                  <b>Nomor WhatsApp:</b> {selectedRow.nomor_whatapp}
                </p>
                <p>
                ...
                <p>
                  <b>Tanggal Lahir:</b> {selectedRow.tanggal_lahir}
                </p>
                <p>
                  <b>Ukuran Kaos:</b> {selectedRow.ukuran_kaos}
                </p>
                <p>
                  <b>Nomor Darurat:</b> {selectedRow.nomor_darurat}
                </p>
                <p>
                  <b>Tipe Nomor Darurat:</b> {selectedRow.tipe_nomor_darurat}
                </p>
                <p>
                  <b>Riwayat Penyakit:</b> {selectedRow.riwayat_penyakit}
                </p>
                <p>
              ...
              <div className="mt-4 d-flex justify-content-center gap-3">
                {selectedRow.status_pembayaran !== "lunas" && (
                  <button
                    ...
                    onClick={() => handleVerifikasi(selectedRow.penerimaan_id)}
                  >
                    ✅ Verifikasi
                  </button>
                )}
